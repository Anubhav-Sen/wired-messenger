...
from wiredAPI.views import authenticate_user, users, user, create_user
...
class TestUris(TestCase):
    ...
    def setUp(self):
        ...
        """
        self.user = get_user_model().objects.create_user(first_name = 'test', last_name = 'test', user_name = 'test', email_address = 'test@test.com', password = 'test-password')
